                        ...
                        <div class="grid w-full h-screen grid-cols-10">
                            ...
                            <div class="grid grid-rows-10 gap-4 col-span-2 justify-center">
                                ...
                                <div class="row-span-1 self-center top-16 relative">
                                    <div @click="openLink('https://twitter.com/station0x')" class="mb-6 cursor-pointer hover:bg-neutral-700  w-[45px] h-[45px] bg-neutral-800 rounded-lg p-2.5">
                                    ...
                                    <div @click="openLink('https://blog.station0x.com')" class="mb-6 cursor-pointer hover:bg-neutral-700  w-[45px] h-[45px] bg-neutral-800 rounded-lg p-2.5">
                                    ...
                                    <div @click="openLink('https://discord.gg/PMZ9UDf7x3')" class="mb-6 cursor-pointer hover:bg-neutral-700  w-[45px] h-[45px] bg-neutral-800 rounded-lg p-2.5">
                                        <svg class="text-neutral-400 w-6 h-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
#main-footer {
    background: linear-gradient(107.35deg, rgba(14, 14, 14, 0.25) 15.06%, rgba(41, 41, 41, 0.3) 100.35%);
}
#play-btn {
