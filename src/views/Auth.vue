        ...
        <div class="grid h-screen grid-cols-10">
            ...
            <div class="flex col-span-3 mt-28 items-center justify-center px-10 py-6 lg:py-0 sm:px-0">
                <form class="w-full px-14 max-w-md space-y-4 md:space-y-6 xl:max-w-xl" action="#">
                    ...
                    <button class="text-black font-bold bg-brand-cold-700 text-lg hover:bg-brand-cold-800 focus:ring-4 focus:outline-none focus:ring-brand-cold-300 rounded-lg w-full sm:w-auto px-5 p-3 text-center dark:bg-brand-cold-500 dark:hover:bg-brand-cold-400 dark:focus:ring-brand-cold-800">Continue
                        <svg class="inline w-5 h-5 ml-2" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
